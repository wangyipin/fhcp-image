...
public class StringUtils
{
	...
	public static void main(String[] args) throws UnsupportedEncodingException
	{
		...
		System.out.println(HtmlUtils.htmlEscape("多一些竞品分析就更完美了"));
	}
	...
	public static String exMobiHtmlEncode(String str)
	{
		if (isEmpty(str))
		{
			return "";
	...
	public static String nullToInt(String strText)
	{
		if (strText == null || strText.trim().length() == 0 || "null".equals(strText))
			return "0";
		return strText.trim();
